    ...
    while True:
        ...
        if opcion == '1':
            ...
            if not estaciones_suelo or not sensores_suelo_ids or not estaciones_cultivo or not sensores_cultivo_ids:
                ...
                matriz_reducida_suelo = reducir_matriz(estaciones_suelo, sensores_suelo_ids)
                print("Matriz reducida de estaciones con sensores (suelo):")
                mostrar_matriz_reducida(matriz_reducida_suelo, sensores_suelo_ids)
                graficar_matriz_reducida(matriz_reducida_suelo, sensores_suelo_ids, "matriz_suelo_reducida")
                matriz_reducida_cultivo = reducir_matriz_cultivo(estaciones_cultivo, sensores_cultivo_ids)
